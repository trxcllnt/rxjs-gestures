...
var PanSubscriber = exports.PanSubscriber = function (_Subscriber) {
    ...
    _createClass(PanSubscriber, [{
        ...
        value: function _next(starts) {
            ...
            _get(PanSubscriber.prototype.__proto__ || Object.getPrototypeOf(PanSubscriber.prototype), '_next', this).call(this, Gestures.pan(presses, { delay: delay, radius: radius }, moves, ends, cancels));
        }
    }]);
