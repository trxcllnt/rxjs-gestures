...
var PanSubscriber = exports.PanSubscriber = function (_Subscriber) {
    ...
    _createClass(PanSubscriber, [{
        ...
        value: function _next(starts) {
            ...
            var presses = Gestures.press(starts, delay, radius, moves, ends, cancels);

            _get(Object.getPrototypeOf(PanSubscriber.prototype), '_next', this).call(this, Gestures.pan(presses, delay, radius, moves, ends, cancels));
        }
    }]);
