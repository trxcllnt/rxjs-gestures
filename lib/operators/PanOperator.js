...
var PanOperator = exports.PanOperator = function () {
    ...
    _createClass(PanOperator, [{
        ...
        value: function call(subscriber, source) {
            return source._subscribe(new PanSubscriber(subscriber, this.delay, this.radius, this.Gestures));
        }
    }]);
...
var PanSubscriber = exports.PanSubscriber = function (_Subscriber) {
    ...
    function PanSubscriber(destination, delay, radius, Gestures) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PanSubscriber).call(this, destination));
    ...
    _createClass(PanSubscriber, [{
        ...
        value: function _next(starts) {
            ...
            var presses = Gestures.press(starts, { delay: delay, radius: radius }, moves, ends, cancels);

            _get(Object.getPrototypeOf(PanSubscriber.prototype), '_next', this).call(this, Gestures.pan(presses, { delay: delay, radius: radius }, moves, ends, cancels));
        }
    }]);
