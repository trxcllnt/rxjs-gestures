...
var _identity = require('rxjs/util/identity');
...
var MultitouchSubscriber = exports.MultitouchSubscriber = function (_MergeMapSubscriber) {
    _inherits(MultitouchSubscriber, _MergeMapSubscriber);

    function MultitouchSubscriber(destination) {
        _classCallCheck(this, MultitouchSubscriber);

        var _this = _possibleConstructorReturn(this, (MultitouchSubscriber.__proto__ || Object.getPrototypeOf(MultitouchSubscriber)).call(this, destination, _identity.identity));
