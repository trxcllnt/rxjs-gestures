...
var MultitouchSubscriber = exports.MultitouchSubscriber = function (_MergeAllSubscriber) {
    ...
    function MultitouchSubscriber(destination) {
        ...
        return _possibleConstructorReturn(this, Object.getPrototypeOf(MultitouchSubscriber).call(this, destination, Number.POSITIVE_INFINITY));
    }
        ...
        value: function _next(event) {
            ...
            if (!isTouch) {
                ...
                this.notifyNext(event, {
                    ...
                    pageX: pageX, pageY: pageY, screenX: screenX, screenY: screenY,
                ...
                while (++touchesIndex < touchesLen) {
                    ...
                    var _screenX = touch.screenX;
                    var _screenY = touch.screenY;
                    var _clientX = touch.clientX;
                    var _clientY = touch.clientY;
                    var _touch$radiusX = touch.radiusX;
                    var radiusX = _touch$radiusX === undefined ? 1 : _touch$radiusX;
                    var _touch$radiusY = touch.radiusY;
                    var radiusY = _touch$radiusY === undefined ? 1 : _touch$radiusY;
                    var _touch$rotationAngle = touch.rotationAngle;
                    var rotationAngle = _touch$rotationAngle === undefined ? 0 : _touch$rotationAngle;

                    this.notifyNext(event, {
                        type: type, event: event, touch: touch, target: target, identifier: identifier,
                        pageX: _pageX, pageY: _pageY, screenX: _screenX, screenY: _screenY,
