...
var _NormalizeOperator = require('./NormalizeOperator');

Object.keys(_NormalizeOperator).forEach(function (key) {
  if (key === "default") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _NormalizeOperator[key];
    }
  });
});

var _MultitouchOperator = require('./MultitouchOperator');

Object.keys(_MultitouchOperator).forEach(function (key) {
  if (key === "default") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _MultitouchOperator[key];
    }
  });
});
