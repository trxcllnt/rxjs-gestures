...
var DecelerateSubscriber = exports.DecelerateSubscriber = function (_Subscriber) {
    ...
    _createClass(DecelerateSubscriber, [{
        ...
        value: function _complete() {
            ...
            var movementTTotal = point.movementTTotal;
            var direction = point.direction;
            var _point$magnitude = point.magnitude;
            var magnitude = _point$magnitude === undefined ? 0 : _point$magnitude;
            ...
            var duration = Math.sqrt(magnitude / (movementTTotal / index) / (normalForce * u)) || 0;
        ...
        value: function dispatch(state) {
            ...
            if (elapsed > duration) {
                ...
                var targetPageX = easingFunc(elapsed, start.targetPageX, distanceX, duration);
                var targetPageY = easingFunc(elapsed, start.targetPageY, distanceX, duration);
