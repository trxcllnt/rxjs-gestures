...
var PressOperator = exports.PressOperator = function () {
    ...
    _createClass(PressOperator, [{
        ...
        value: function call(subscriber, source) {
            return source._subscribe(new PressSubscriber(subscriber, this.delay, this.radius, this.Gestures));
        }
    }]);
...
var PressSubscriber = exports.PressSubscriber = function (_Subscriber) {
    ...
    function PressSubscriber(destination, delay, radius, Gestures) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PressSubscriber).call(this, destination));
    ...
    _createClass(PressSubscriber, [{
        ...
        value: function _next(starts) {
            ...
            _get(Object.getPrototypeOf(PressSubscriber.prototype), '_next', this).call(this, Gestures.press(starts, { delay: delay, radius: radius }, moves, ends, cancels));
        }
    }]);
