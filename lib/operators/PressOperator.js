...
var PressSubscriber = exports.PressSubscriber = function (_Subscriber) {
    ...
    _createClass(PressSubscriber, [{
        ...
        value: function _next(starts) {
            ...
            _get(PressSubscriber.prototype.__proto__ || Object.getPrototypeOf(PressSubscriber.prototype), '_next', this).call(this, Gestures.press(starts, { delay: delay, radius: radius }, moves, ends, cancels));
        }
    }]);
