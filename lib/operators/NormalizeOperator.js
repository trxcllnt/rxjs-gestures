...
var NormalizeSubscriber = exports.NormalizeSubscriber = function (_Subscriber) {
    ...
    _createClass(NormalizeSubscriber, [{
        ...
        value: function _next(multitouchEvent) {
            ...
            var deltaT = time - previous.time;
            var deltaXTotal = deltaX + previous.deltaXTotal;
            var deltaYTotal = deltaY + previous.deltaYTotal;
            var direction = Math.atan2(deltaY / deltaT, deltaX / deltaT) || 0;
