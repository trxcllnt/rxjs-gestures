    ...
    _createClass(NormalizeSubscriber, [{
        ...
        value: function _next(multitouchEvent) {
            ...
            var type = multitouchEvent.type,
                ...
                button = multitouchEvent.button,
                buttons = multitouchEvent.buttons,
            ...
            var sampleTTotal = time - this.sampleT;
            var sampleXTotal = pageX - this.sampleX;
            var sampleYTotal = pageY - this.sampleY;
            ...
            var speed = Math.sqrt(distance / (sampleTTotal || 1) / 5) || 0;
        ...
        value: function createOrigin(event, touch, time, Gestures) {
            ...
            var parent = target.offsetParent || target.parentNode || topLevelElement;
            ...
            var _parent$getBoundingCl = parent.getBoundingClientRect(),
                ...
                parentBottom = _parent$getBoundingCl.bottom;

            var offsetLeft = target.offsetLeft,
                offsetTop = target.offsetTop;

            'ownerSVGElement' in target && (_target$getBBox = target.getBBox(), offsetLeft = _target$getBBox.x, offsetTop = _target$getBBox.y, _target$getBBox);
