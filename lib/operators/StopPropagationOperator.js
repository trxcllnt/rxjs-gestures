...
var StopPropagationSubscriber = function (_Subscriber) {
    ...
    function StopPropagationSubscriber(destination, immediate) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(StopPropagationSubscriber).call(this, destination));
    ...
    _createClass(StopPropagationSubscriber, [{
        ...
        value: function _next(maybeNormalized) {
            ...
            var event = _maybeNormalized$even === undefined ? maybeNormalized : _maybeNormalized$even;
            ...
            _get(Object.getPrototypeOf(StopPropagationSubscriber.prototype), '_next', this).call(this, maybeNormalized);
        }
    }]);
