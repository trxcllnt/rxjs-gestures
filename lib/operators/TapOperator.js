...
var TapOperator = exports.TapOperator = function () {
    ...
    _createClass(TapOperator, [{
        ...
        value: function call(subscriber, source) {
            return source.subscribe(new TapSubscriber(subscriber, this.timeout, this.radius, this.Gestures));
        }
    }]);
...
var TapSubscriber = exports.TapSubscriber = function (_Subscriber) {
    ...
    function TapSubscriber(destination, timeout, radius, Gestures) {
        ...
        var _this = _possibleConstructorReturn(this, (TapSubscriber.__proto__ || Object.getPrototypeOf(TapSubscriber)).call(this, destination));
    ...
    _createClass(TapSubscriber, [{
        ...
        value: function _next(starts) {
            ...
            _get(TapSubscriber.prototype.__proto__ || Object.getPrototypeOf(TapSubscriber.prototype), '_next', this).call(this, Gestures.tap(starts, ends, cancels, { timeout: timeout, radius: radius }));
        }
    }]);
