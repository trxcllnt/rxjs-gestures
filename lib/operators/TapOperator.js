...
var TapSubscriber = exports.TapSubscriber = function (_Subscriber) {
    ...
    _createClass(TapSubscriber, [{
        ...
        value: function _next(starts) {
            ...
            _get(TapSubscriber.prototype.__proto__ || Object.getPrototypeOf(TapSubscriber.prototype), '_next', this).call(this, Gestures.tap(starts, { timeout: timeout, radius: radius }, ends, cancels));
        }
    }]);
