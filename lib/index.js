...
var Gestures = exports.Gestures = function (_Observable) {
    ...
    _createClass(Gestures, [{
        ...
        value: function delta(point) {
            var scheduler = arguments.length <= 1 || arguments[1] === undefined ? _rxjs.Scheduler.async : arguments[1];
        ...
        value: function decelerate() {
            ...
            var scheduler = arguments.length <= 2 || arguments[2] === undefined ? _rxjs.Scheduler.async : arguments[2];
        ...
        value: function tap() {
            ...
            return new this(target).preventDefault().mergeMap(function (start) {
                ...
                }).timeoutWith(timeout, _rxjs.Observable.empty());
        ...
        value: function press() {
            ...
            return (delay <= 0 ? target : new this(target).preventDefault().mergeMap(function (start) {
                return _rxjs.Observable.timer(delay).withLatestFrom(moves.startWith(start), function (i, move) {
