...
function install() {
    ...
    return wrapStaticObservableMethods(_rxjs.Observable, (_temp = _class = function (_Gestures) {
...
var Gestures = function (_Observable) {
    ...
    _createClass(Gestures, [{
        ...
        value: function decelerate() {
            var coefficientOfFriction = arguments.length <= 0 || arguments[0] === undefined ? 25 : arguments[0];
            var speedLimit = arguments.length <= 1 || arguments[1] === undefined ? 200 : arguments[1];
        ...
        value: function inside(_ref2) {
            ...
            return this.filter(function (_ref3) {
                ...
                var movementYTotal = _ref3.movementYTotal;
        ...
        value: function outside(_ref4) {
            ...
            return this.filter(function (_ref5) {
                ...
                var movementYTotal = _ref5.movementYTotal;
                return (0, _support.epsilon)(radiusX, radiusY, movementXTotal, movementYTotal);
            });
        }
    }, {
        ...
        value: function normalize(origin) {
            var Gestures_ = arguments.length <= 1 || arguments[1] === undefined ? this.constructor : arguments[1];
            var scheduler = arguments.length <= 2 || arguments[2] === undefined ? _rxjs.Scheduler.animationFrame : arguments[2];
        ...
        value: function startsById() {
            ...
            var inputs = arguments.length <= 1 || arguments[1] === undefined ? 1 : arguments[1];

            return this.start(target).groupBy(getIdentifier).take(inputs).map(function (group) {
                var connectable = group.multicast(function () {
        ...
        value: function tap() {
            ...
            var _ref6$inputs = _ref6.inputs;
            var inputs = _ref6$inputs === undefined ? 1 : _ref6$inputs;
            var _ref6$timeout = _ref6.timeout;
            var timeout = _ref6$timeout === undefined ? 250 : _ref6$timeout;
            var _ref6$radius = _ref6.radius;
            var radius = _ref6$radius === undefined ? { x: 10, y: 10 } : _ref6$radius;
            ...
            if (arguments.length <= 2) {
                return this.startsById(target, inputs).lift(new _operators.TapOperator(timeout, radius, this));
            }

            ends = ends instanceof this && ends || new this(ends);
            target = target instanceof this && target || new this(target);

            return target.preventDefault().normalize(null, this).mergeMap(function (start) {
                return ends.preventDefault().normalize(start, _this3).inside(radius).timeoutWith(timeout, _rxjs.Observable.empty());
        ...
        value: function press() {
            ...
            var _ref7$inputs = _ref7.inputs;
            var inputs = _ref7$inputs === undefined ? 1 : _ref7$inputs;
            var _ref7$delay = _ref7.delay;
            var delay = _ref7$delay === undefined ? 0 : _ref7$delay;
            var _ref7$radius = _ref7.radius;
            var radius = _ref7$radius === undefined ? { x: 10, y: 10 } : _ref7$radius;
            var moves = arguments[2];
            ...
            if (arguments.length <= 2) {
                return this.startsById(target, inputs).lift(new _operators.PressOperator(delay, radius, this));
            }

            target = target instanceof this && target || new this(target);

            if (delay <= 0) {
                return target.normalize(null, this).take(1);
            }
        ...
        value: function pan() {
            ...
            var _ref8$inputs = _ref8.inputs;
            var inputs = _ref8$inputs === undefined ? 1 : _ref8$inputs;
            var _ref8$delay = _ref8.delay;
            var delay = _ref8$delay === undefined ? 0 : _ref8$delay;
            var _ref8$radius = _ref8.radius;
            var radius = _ref8$radius === undefined ? { x: 10, y: 10 } : _ref8$radius;
            var moves = arguments[2];
            ...
            if (arguments.length <= 2) {
                return this.startsById(target, inputs).lift(new _operators.PanOperator(delay, radius, this));
            }
            ends = ends instanceof this && ends || new this(ends);
            moves = moves instanceof this && moves || new this(moves);
            target = target instanceof this && target || new this(target);
            return target.preventDefault().mergeMap(function (start) {
...
exports.Gestures = Gestures = wrapStaticObservableMethods(_rxjs.Observable, Gestures);
