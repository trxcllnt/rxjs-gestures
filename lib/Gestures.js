...
var Gestures = function (_Observable) {
    ...
    _createClass(Gestures, [{
        ...
        value: function decelerate() {
            ...
            var speedLimit = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 200;
            var scheduler = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _rxjs.Scheduler.animationFrame;
